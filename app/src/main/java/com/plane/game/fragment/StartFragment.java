...
import com.plane.game.activity.FeedbackActivity;
import com.plane.game.activity.FeedbackActivity_;
...
//			btn_rank.setVisibility(View.VISIBLE);    //世界排行
...
//			btn_rank.setVisibility(View.VISIBLE);
	...
	@Click
	void btn_feedback() {
		getActivity().startActivity(new Intent(getActivity(), FeedbackActivity_.class));
	}
